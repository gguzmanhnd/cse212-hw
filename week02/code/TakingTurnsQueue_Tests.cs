...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue used Insert(0) instead of Add() 
    ...
    // Defect(s) Found: Queue ordering was inverted due to improper Enqueue implementation.  PersonQueue used Insert(0) instead of Add()
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite turns (0 or negative) were not re-enqueued because the condition chequed only person.Turns > 1.
    ...
    // Defect(s) Found: Negative turns values for infinite loops were treated as finite and dropped when turns reached 0 or less.
